...
public class MissionController {
    ...
    public static MissionManager getMissionManager() {
        if (null == missionManager) {
            try {
                missionManager = new MissionManager(new Rover());
    ...
    public Response getIndex() {
        ...
        for (int i = 0; i < getMissionManager().getBounds().getHeight(); i++) {
    ...
    public Response sendCommands(CommandsViewModel input) {
        ...
        List<Obstacle> oldCollection = getMissionManager().getObstacles();
        ...
        final List<Obstacle> newCollection = getMissionManager().getObstacles();
        final List<MapPositionViewModel> updatedObstacles = convertToViewModels(getMissionManager().getObstacles());
    ...
    private List<String> getGroundRow() {
        ...
        for (int i = 0; i < getMissionManager().getBounds().getWidth(); i++) {
