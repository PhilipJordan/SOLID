...
namespace MarsRoverMunged
{
    public class Everything
    {
        ...
        private List<Point> MarsObstacles;
        ...
        public void Run()
        {
            ...
            CaptureObstacles();
            if(MarsObstacles.Any(x => x.Equals(roverLocation)))
            ...
            while (!input.Equals("q", StringComparison.CurrentCultureIgnoreCase))
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("The rover is facing " + roverFacing.ToString());
                    Console.WriteLine();
                    Console.WriteLine();
        ...
        private Point CalculateFinalPosition(Point roverLocation, Point desiredPosition)
        {
            ...
            bool anyInstance = MarsObstacles.Any(x => x.Equals(newDestination));
            if (anyInstance)
            {
