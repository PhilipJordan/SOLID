...
public class Mars {
    ...
    public void updateAliens() {
        List<IObstacle> obstacles = new ArrayList<IObstacle>(getObstacles());
        for (IObstacle alien : Collections2.filter(obstacles, new Predicate<IObstacle>() {
            @Override
    ...
    public void addObstacle(Point location) { obstacles.add(new Obstacle(location)); }
